...
# IONode: Perhaps this isn't required?
# I'm not sure, AOSP wants it and it's present in Z2.
# regretfully this is dependent on proprietary QCOM BT code. =<
# Because of this, Vendor may be slightly incomplete.
include $(CLEAR_VARS)
...
# IONode: This seems to be totally required; AOSP really wants it.
# In CyanogenMod it may not be required; but since I need it..
include $(CLEAR_VARS)
